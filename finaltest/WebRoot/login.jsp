...
<div class="login">
	<div class="box-header">
		<sapn><a href="login.jsp" style="color: white; font-weight:bold;">用户登陆</a></sapn>
		<span><a href="login_2.jsp">管理员登陆</a></span>
	</div>
	<div class="box-body">
		<form class="form-signin" action="userlogin" method="post">
			...
			<a href="regist.jsp" class="btn btn-lg btn-primary btn-block">注册</a>
		</form>
